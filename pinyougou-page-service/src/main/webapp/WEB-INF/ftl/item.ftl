					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" class="{{isChecked('${spec.attributeName}','${value}')?'selected':''}}" ng-click="addSpec('${spec.attributeName}','${value}')">${value}
								<span title="点击取消选择">&nbsp;
								</span>
								</a></dd>
								</#list>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" ng-model="num" minnum="1" class="itxt" readOnly />
